...
public class GDEBlockPlantsData : Scriptable, ISimulationData, IProgressionObject
{
    ...
    public Dictionary<string, SimOptions> TagObjectsByOptionID { get; private set; } = new Dictionary<string, SimOptions>();
    ...
    public override void OnLoaded()
    {
        ...
        if (Layer == BlockLayers.NONE)
        {
            Debug.LogError($"BlockPlantsData {Key} has no layer set!");
        }
