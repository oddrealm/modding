public readonly struct SimulationState
{
    ...
    public SimulationState(SimTime spawnTimestamp, SimTime lastSimulationTimestamp)
    {
        ...
        this.lastSimulationTimestamp = lastSimulationTimestamp;
    }

    public static SimulationState NewCurrentTime()
    {
        SimTime currentTime = _session.GameTime.TotalElapsedMinutes;
        return new SimulationState(currentTime, currentTime);
    }
